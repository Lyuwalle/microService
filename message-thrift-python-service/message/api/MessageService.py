...
class Client(Iface):
    ...
    def sendMobileMessage(self, mobileNumber, message):
        ...
        """
        self.send_sendMobileMessage(mobileNumber, message)
        return self.recv_sendMobileMessage()

    def send_sendMobileMessage(self, mobileNumber, message):
...
class Processor(Iface, TProcessor):
    ...
    def process_sendMobileMessage(self, seqid, iprot, oprot):
        ...
        result = sendMobileMessage_result()
        try:
            result.success = self._handler.sendMobileMessage(args.mobileNumber, args.message)
...
class sendMobileMessage_args(object):
    ...
    def __init__(self, mobileNumber=None, message=None,):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.mobileNumber = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.mobileNumber is not None:
            ...
            oprot.writeString(self.mobileNumber.encode('utf-8') if sys.version_info[0] == 2 else self.mobileNumber)
            oprot.writeFieldEnd()
...
sendMobileMessage_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'mobileNumber', 'UTF8', None, ),  # 1
