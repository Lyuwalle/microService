 ...
 *  @generated
 */
package com.fuck.ccp.message;

@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.16.0)", date = "2022-08-21")
public class MessageService {

  public interface Iface {

    public boolean sendMobileMessage(java.lang.String mobileNumber, java.lang.String message) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void sendMobileMessage(java.lang.String mobileNumber, java.lang.String message, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public boolean sendMobileMessage(java.lang.String mobileNumber, java.lang.String message) throws org.apache.thrift.TException
    {
      send_sendMobileMessage(mobileNumber, message);
      return recv_sendMobileMessage();
    }

    public void send_sendMobileMessage(java.lang.String mobileNumber, java.lang.String message) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void sendMobileMessage(java.lang.String mobileNumber, java.lang.String message, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      sendMobileMessage_call method_call = new sendMobileMessage_call(mobileNumber, message, resultHandler, this, ___protocolFactory, ___transport);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class sendMobileMessage<I extends Iface> extends org.apache.thrift.ProcessFunction<I, sendMobileMessage_args> {
      ...
      public sendMobileMessage_result getResult(I iface, sendMobileMessage_args args) throws org.apache.thrift.TException {
        sendMobileMessage_result result = new sendMobileMessage_result();
        result.success = iface.sendMobileMessage(args.mobileNumber, args.message);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class sendMobileMessage<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sendMobileMessage_args, java.lang.Boolean> {
      ...
      public void start(I iface, sendMobileMessage_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException {
        iface.sendMobileMessage(args.mobileNumber, args.message,resultHandler);
      }
    }
  ...
  public static class sendMobileMessage_args implements org.apache.thrift.TBase<sendMobileMessage_args, sendMobileMessage_args._Fields>, java.io.Serializable, Cloneable, Comparable<sendMobileMessage_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.lang.String mobileNumber; // required
    ...
    public sendMobileMessage_args setMobileNumber(@org.apache.thrift.annotation.Nullable java.lang.String mobileNumber) {
      this.mobileNumber = mobileNumber;
      return this;
    }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetMobileNumber()) ? 131071 : 524287);
      if (isSetMobileNumber())
        hashCode = hashCode * 8191 + mobileNumber.hashCode();
    ...
    public int compareTo(sendMobileMessage_args other) {
      ...
      lastComparison = java.lang.Boolean.compare(isSetMobileNumber(), other.isSetMobileNumber());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetMobileNumber()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.mobileNumber, other.mobileNumber);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    private static class sendMobileMessage_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<sendMobileMessage_args> {
          ...
          switch (schemeField.id) {
            case 1: // MOBILE_NUMBER
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.mobileNumber = iprot.readString();
                struct.setMobileNumberIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sendMobileMessage_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.mobileNumber != null) {
          oprot.writeFieldBegin(MOBILE_NUMBER_FIELD_DESC);
          oprot.writeString(struct.mobileNumber);
          oprot.writeFieldEnd();
        }
